...
var orderData = /** @class */ (function () {
    ...
    // writing index model
    orderData.prototype.index = function () {
    ...
    orderData.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, info, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    orderData.prototype.create = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, newOrder, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    orderData.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, newDelete, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = 'DELETE FROM orders WHERE id=($1) RETURNING status, email';
                        return [4 /*yield*/, connect.query(sql, [id])];
                    case 2:
                        result = _a.sent();
                        newDelete = result.rows[0];
                        connect.release();
                        return [2 /*return*/, newDelete];
                    case 3:
                        error_4 = _a.sent();
                        console.log(error_4);
    ...
    // creating cart
    orderData.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // user cart index
    orderData.prototype.cart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
