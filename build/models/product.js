...
var productsData = /** @class */ (function () {
    function productsData() {
    }
    // the index module
    productsData.prototype.indexProduct = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, allproducts, err_1;
    ...
    productsData.prototype.showProduct = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, product, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    productsData.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, newProduct, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    // the delete module
    productsData.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, result, newDelete, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        connect = _a.sent();
                        sql = 'DELETE FROM products WHERE id=($1) RETURNING name';
                        return [4 /*yield*/, connect.query(sql, [id])];
                    case 2:
                        result = _a.sent();
